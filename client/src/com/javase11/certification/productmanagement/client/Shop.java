...
package com.javase11.certification.productmanagement.client;
...
import com.javase11.certification.productmanagement.service.ProductManager;
import com.javase11.certification.productmanagement.service.ProductManagerException;
...
public class Shop {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            final ServiceLoader<ProductManager> serviceLoader = ServiceLoader.load(ProductManager.class);
            final ProductManager pm = serviceLoader.findFirst().get();
