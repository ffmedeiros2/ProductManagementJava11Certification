...
package com.javase11.certification.productmanagement.service.file;

import com.javase11.certification.productmanagement.data.*;
...
public class ProductFileManager implements ProductManager {
    ...
    private final ResourceBundle config = ResourceBundle.getBundle(
            "com/javase11/certification/productmanagement/service/file/config");
